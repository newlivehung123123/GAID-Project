...
const FILTER_YEARS = ["2030", "2029", "2028"];
const SORT_OPTIONS = [
                  ...
                  >
                    <div className="md:w-1/3 relative overflow-hidden h-48 md:h-auto">
                      ...
                      <div className="absolute top-2 left-2">
                        <span className={`text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded bg-black/50 backdrop-blur-sm border ${
                          article.articleType === 'Analysis' ? 'text-purple-300 border-purple-500/50' : 
                          article.articleType === 'Perspective' ? 'text-green-300 border-green-500/50' : 
